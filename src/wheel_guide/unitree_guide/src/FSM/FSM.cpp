...
FSM::FSM(CtrlComponents *ctrlComp)
    ...
    _stateList.wheelVmcTest = new State_WheelVmcTest(_ctrlComp);
    _stateList.wheelRlVmc = new State_WheelRlVmc(_ctrlComp);
    initialize();
}
...
FSMState* FSM::getNextState(FSMStateName stateName){
    ...
    case FSMStateName::FIXEDSTAND:
        ...
        break;
    case FSMStateName::WHEELVMCTEST:
        return _stateList.wheelVmcTest;
        break;
    case FSMStateName::WHEELRLVMC:
        return _stateList.wheelRlVmc;
        break;
    default:
        return _stateList.invalid;
        break;
