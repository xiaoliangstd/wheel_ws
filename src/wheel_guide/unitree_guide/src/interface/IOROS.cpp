...
void IOROS::initSend(){
    _servo_pub[0] = _nm.advertise<unitree_legged_msgs::MotorCmd>("/" + _robot_name + "_gazebo/lf0_controller/command", 1);
    _servo_pub[1] = _nm.advertise<unitree_legged_msgs::MotorCmd>("/" + _robot_name + "_gazebo/lf1_controller/command", 1);
    _servo_pub[2] = _nm.advertise<unitree_legged_msgs::MotorCmd>("/" + _robot_name + "_gazebo/l_wheel_controller/command", 1);
    _servo_pub[3] = _nm.advertise<unitree_legged_msgs::MotorCmd>("/" + _robot_name + "_gazebo/rf0_controller/command", 1);
    _servo_pub[4] = _nm.advertise<unitree_legged_msgs::MotorCmd>("/" + _robot_name + "_gazebo/rf1_controller/command", 1);
    _servo_pub[5] = _nm.advertise<unitree_legged_msgs::MotorCmd>("/" + _robot_name + "_gazebo/r_wheel_controller/command", 1);
...
void IOROS::initRecv(){
    ...
    _servo_sub[0] = _nm.subscribe("/" + _robot_name + "_gazebo/lf0_controller/state", 1, &IOROS::lf0Callback, this);
    _servo_sub[1] = _nm.subscribe("/" + _robot_name + "_gazebo/lf1_controller/state", 1, &IOROS::lf1Callback, this);
    _servo_sub[2] = _nm.subscribe("/" + _robot_name + "_gazebo/l_wheel_controller/state", 1, &IOROS::lwheelCallback, this);
    _servo_sub[3] = _nm.subscribe("/" + _robot_name + "_gazebo/rf0_controller/state", 1, &IOROS::rf0Callback, this);
    _servo_sub[4] = _nm.subscribe("/" + _robot_name + "_gazebo/rf1_controller/state", 1, &IOROS::rf1Callback, this);
    _servo_sub[5] = _nm.subscribe("/" + _robot_name + "_gazebo/r_wheel_controller/state", 1, &IOROS::rwheelCallback, this);
...
void IOROS::lf0Callback(const unitree_legged_msgs::MotorState& msg)
{
...
void IOROS::lf1Callback(const unitree_legged_msgs::MotorState& msg)
{
...
void IOROS::lwheelCallback(const unitree_legged_msgs::MotorState& msg)
{
...
void IOROS::rf0Callback(const unitree_legged_msgs::MotorState& msg)
{
...
void IOROS::rf1Callback(const unitree_legged_msgs::MotorState& msg)
{
...
void IOROS::rwheelCallback(const unitree_legged_msgs::MotorState& msg)
{
